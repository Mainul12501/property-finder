                                        ...
                                        <div class="dropdown-wrapper-content">
                                            <div class="range-selector">
                                                ...
                                                <div class="range-selector-box">
                                                    ...
                                                    <input type="text" class="form-control" name="max_price" placeholder="{{ Session::has('eng') ? 'Max. Price' : '' }}{{ Session::has('kaz') ? 'Максималды. Бағасы' : '' }}{{ Session::has('rus') ? 'Максимум. Цена' : '' }} ({{ Session::has('kaz') ? 'Tenge' : 'AED' }})">
                                                </div>
                                            </div>
...
{{--                                            <h4>{{ number_format($property->rent_charge_per_year) }} AED/year</h4>--}}
...
{{--                        </div>--}}
{{--                        <div class="rent-contents-end-links">--}}
{{--                            <a href="">Penthouses for rent</a>--}}
{{--                        </div>--}}
{{--                        <div class="rent-contents-end-links">--}}
{{--                            <a href="">Compounds for rent</a>--}}
{{--                        </div>--}}
{{--                        <div class="rent-contents-end-links">--}}
{{--                            <a href="">Duplexes for rent</a>--}}
{{--                        </div>--}}
{{--                        <div class="rent-contents-end-links">--}}
{{--                            <a href="">Bungalows for rent</a>--}}
{{--                        </div>--}}
{{--                        <div class="rent-contents-end-links">--}}
...
{{--                        </div>--}}
{{--                        <div class="rent-contents-end-links">--}}
{{--                            <a href="">3 bedroom properties for rent</a>--}}
{{--                        </div>--}}
{{--                        <div class="rent-contents-end-links">--}}
{{--                            <a href="">4 bedroom properties for rent</a>--}}
{{--                        </div>--}}
{{--                        <div class="rent-contents-end-links">--}}
{{--                            <a href="">5 bedroom properties for rent</a>--}}
{{--                        </div>--}}
{{--                    </div>--}}
{{--                    <div class="rent-contents-end">--}}
{{--                        <h5>Популярные запросы</h5>--}}
...
{{--                        <h5>Недвижимость на продажу</h5>--}}
{{--                        <div class="rent-contents-end-links">--}}
{{--                            <a href="">Недвижимость на продажу</a>--}}
{{--                        </div>--}}
{{--                    </div>--}}
{{--                </div>--}}
{{--            </div>--}}
