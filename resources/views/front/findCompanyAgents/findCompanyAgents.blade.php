...
{{--                                </select>--}}
                            ...
                            <div class="col-lg-4">
{{--                                <select class="form-select form-select-sm" id="nationality">--}}
{{--                                    <option selected="">Национальность</option>--}}
{{--                                    <option value="1">One</option>--}}
{{--                                    <option value="2">Two</option>--}}
{{--                                    <option value="3">Three</option>--}}
{{--                                </select>--}}
...
@section('front-js')
    <script>
        $(document).on('click', '#agents', function () {
            $('#searchType').val('agent');
        })
        $(document).on('click', '#companies', function () {
            $('#searchType').val('company');
            // $('#nationality').val('');
            // $('#language').val('');
        })
        $('#agentSearchBtn').click(function () {
            document.getElementById('agentCompanySearchForm').submit();
        });
    </script>
@endsection
