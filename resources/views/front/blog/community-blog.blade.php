...
@section('title')
    Property Finder - community blog
@endsection
            ...
            <div class="row">
                                ...
                                <div class="col-lg-6 col-md-6 mb-4">
                                    <div class="blog-card">
                                        <div class="blog-card-image">
                                            <a href="{{ route('community-blog-details', ['id' => $blog->id, 'slug' => $blog->slug]) }}" class="d-block">
                                        ...
                                        <div class="blog-card-overlay">
                                            <div class="d-flex align-items-center justify-content-center" style="height: 100%;">
                                                <a href="{{ route('community-blog-details', ['id' => $blog->id, 'slug' => $blog->slug]) }}" class="btn">
                                                        <span>
                ...
                <div class="col-lg-4 blogs-area-border">
                    <div class="blogs-area-form" style="margin-top: 30px;">
                        <form action="{{ route('search-community-blog') }}" method="post" id="blogSearchForm">
                            @csrf
                        ...
                        @if(count($popularBlogs)>0)
                            @foreach($popularBlogs as $popularBlog)
                                <div class="popular-posts-single">
                                    <div class="image">
                                        <a href="{{ route('community-blog-details', ['id' => $popularBlog->id, 'slug' => $popularBlog->slug]) }}" class="d-inline-block">
                    ...
                    <div class="popular-posts mb-4">
                        ...
                        @if(count($latestBlogs)>0)
                            @foreach($latestBlogs as $latestBlog)
                                <div class="popular-posts-single">
                                    <div class="image">
                                        <a href="{{ route('community-blog-details', ['id' => $latestBlog->id, 'slug' => $latestBlog->slug]) }}" class="d-inline-block">
