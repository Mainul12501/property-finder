                ...
                <div class="col-lg-8">
                                ...
                                <div class="col-lg-6 col-md-6 mb-4">
                                    <div class="blog-card">
                                        <div class="blog-card-image">
                                            <a href="{{ route('renter-blog-details', ['id' => $blog->id, 'slug' => $blog->slug]) }}" class="d-block">
                                        ...
                                        <div class="blog-card-overlay">
                                            <div class="d-flex align-items-center justify-content-center" style="height: 100%;">
                                                <a href="{{ route('renter-blog-details', ['id' => $blog->id, 'slug' => $blog->slug]) }}" class="btn">
                                                        <span>
                    ...
                    @else
                        <div style="min-height: 400px">
                            <h5 class="text-capitalize  mt-5">Sorry, No information found....</h5>
                        </div>
                    @endif
                </div>
                <div class="col-lg-4 blogs-area-border">
                    <div class="blogs-area-form" style="margin-top: 30px;">
                        <form action="{{ route('search-renter-blog') }}" method="post" id="blogSearchForm">
                            @csrf
                        ...
                        @if(count($popularBlogs)>0)
                            @foreach($popularBlogs as $popularBlog)
                                <div class="popular-posts-single">
                                    <div class="image">
                                        <a href="{{ route('renter-blog-details', ['id' => $popularBlog->id, 'slug' => $popularBlog->slug]) }}" class="d-inline-block">
                    ...
                    <div class="popular-posts mb-4">
                        ...
                        @if(count($latestBlogs)>0)
                            @foreach($latestBlogs as $latestBlog)
                                <div class="popular-posts-single">
                                    <div class="image">
                                        <a href="{{ route('renter-blog-details', ['id' => $latestBlog->id, 'slug' => $latestBlog->slug]) }}" class="d-inline-block">
