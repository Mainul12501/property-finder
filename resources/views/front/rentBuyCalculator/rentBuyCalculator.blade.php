...
{{--                            <p>What is your yearly rent?</p>--}}
                            <p>Какова ваша годовая арендная плата?</p>
                            ...
                            <h6>8,000 AED ежемесячно</h6>
                        </div>
                        <div class="calc-area-start-single">
{{--                            <p>How much does the property cost?</p>--}}
                            <p>Сколько стоит недвижимость?</p>
                            <form action="" class="calc-area-form">
...
{{--                            <p>What is your down payment amount?</p>--}}
                            <p>Какова сумма вашего первоначального взноса?</p>
                            <form action="" class="calc-area-form">
...
{{--                            <p>How long are you planning to stay in the property?</p>--}}
                            <p>Как долго вы планируете оставаться в собственности?</p>
                            <form action="" class="calc-area-form">
                ...
                <div class="col-lg-8">
                    <div class="calc-area-end">
                        <div class="calc-area-end-top">
                            <h4><span id="chartTitleFirst">Buying</span> является <span id="chartTitlePercent">33</span>% дешевле чем <span id="chartTitleSecond">renting</span></h4>
                            ...
                            <ul class="nav nav-tabs" id="myTab" role="tablist">
                                <li class="nav-item" role="presentation">
                                    <button class="calc-navs-btn nav-link" id="one-tab" data-bs-toggle="tab" data-bs-target="#one"
                                            ...
                                            style="border-right:none!important;">Разбивка стоимости аренды{{--Rent cost breakdown--}}</button>
                                </li>
                                <li class="nav-item" role="presentation">
                                    <button class="nav-link calc-navs-btn active" id="two-tab" data-bs-toggle="tab" data-bs-target="#two"
                                            type="button" role="tab" aria-controls="two" aria-selected="false">Разбивка стоимости покупки{{--Buy cost breakdown--}}</button>
                                </li>
                            </ul>
...
{{--                                            </div>--}}
                                        ...
                                        <div class="calc-navs-content-single border-top-0">
                                            <span class="calc-navs-text">{{--Ejari fee--}}Плата Эджари</span>

                                            <span class="calc-navs-digit">195 AED</span>
                                        </div>
                                        <div class="calc-navs-content-single calc-navs-content-single-footer border-top-0">
                                            <span class="calc-navs-text">{{--Total rental cost over--}}Общая стоимость аренды более <span class="durationInYears">5</span> <!--years-->годы</span>
                                            <span class="calc-navs-digit" id="rentTabTotalRentCost">486,015 AED</span>
                                        </div>
                                    </div>
                                    <div class="calc-navs-bottom">
                                        <div>
                                            <h4 class="mb-0">{{--Looking to rent?--}}Хотите арендовать?</h4>
                                            <p class="mb-0 mt-2">{{--Choose from thousands of properties available for rent in Dubai--}}Выбирайте из тысяч объектов недвижимости, доступных для аренды в Казахстане</p>
                                        </div>
                                        <div>
                                            <div>
                                                <a href="{{ route('rent-page') }}" class="red-btn-lg d-inline-block">{{--Find properties for rent--}}Найти недвижимость в аренду</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="tab-pane fade show active" id="two" role="tabpanel" aria-labelledby="two-tab">
                                    <div class="calc-navs-content">
                                        <div class="calc-navs-content-single">
                                            <span class="calc-navs-text">{{--Purchase price--}}Цена покупки</span>
                                            <span class="calc-navs-digit" id="buyTabPurchasePrice">1,100,000 AED</span>
                                        </div>
                                        <div class="calc-navs-content-single border-top-0">
                                            <span class="calc-navs-text">{{--Down payment of--}}Первоначальный взнос 20%</span>
                                            <span class="calc-navs-digit" id="buyTabDownPayment">220,000 AED</span>
                                        </div>
                                        <div class="calc-navs-content-single border-top-0">
                                            <span class="calc-navs-text">{{--Principal amount--}}Основная сумма</span>
                                            <span class="calc-navs-digit" id="buyTabPrincipalAmount">880,000 AED</span>
                                        </div>
                                        <div class="calc-navs-content-single border-top-0">
                                          <span class="calc-navs-text">{{--Buying fees--}}Плата за покупку
...
{{--                                            </details>--}}
                                        ...
                                        <div class="calc-navs-content-single border-top-0">
                                            <span class="calc-navs-text">{{--Monthly Company payment--}}Ежемесячный платеж компании</span>
                                            <span class="calc-navs-digit" id="buyTabCompanyMonthlyFee">4,038 AED</span>
                                        </div>
                                        <div class="calc-navs-content-single calc-navs-content-single-footer border-top-0">
                                            <span class="calc-navs-text">{{--Total buying cost over--}}Общая стоимость покупки свыше <span class="durationInYears"></span> <!--years-->годы</span>
                                            <span class="calc-navs-digit">324,420 AED</span>
                                        </div>
                                    </div>
                                    <div class="calc-navs-bottom">
                                        <div>
                                            <h4 class="mb-0">{{--Ready to buy?--}}Готовы купить?</h4>
                                            <p class="mb-0 mt-2">{{--Choose from thousands of properties available for sale in Dubai--}}Выберите из тысяч объектов недвижимости, доступных для продажи в Казахстане</p>
                                        </div>
                                        <div class="calc-navs-bottom-last">
                                            <div>
                                                <a href="{{ route('buy-page') }}" class="red-btn-lg d-inline-block mb-3">{{--Find properties for sale--}}Найти недвижимость на продажу</a>
                                            </div>
{{--                                            <div>--}}
...
{{--                                            </div>--}}
    ...
    <section class="calc-text-area">
        <div class="container custom-container">
            <div class="row">
                <div class="col-lg-6">
                    <h4>{{--Buy vs Rent Methodology--}}Методология покупки и аренды</h4>
{{--                    <p>--}}
...
{{--                    </p>--}}
                    <p>
                        Наша покупка против Методология калькулятора арендной платы сравнивает общую стоимость аренды с общей стоимостью покупки, рассматривая гораздо больше, чем ежемесячная арендная плата или платеж по ипотеке.
                    </p>
                    <p>
...
{{--                        may incur as a tenant.--}}
                        Чтобы рассчитать стоимость аренды, мы начинаем с ежемесячной арендной платы, единовременной комиссии агента на основе общей суммы годовой арендной платы и ежегодных сборов EJARI. Этот расчет не включает плату за обслуживание, которую вы можете понести как арендатор.
                    </p>
                    <p>
                        ...
                        Чтобы рассчитать стоимость покупки, мы начинаем с покупной цены и рассчитываем первоначальный взнос и
                        задействованы различные сборы; ежемесячная комиссия агента по ипотечным платежам, регистрационные сборы Земельного департамента Дубая, сборы за регистрацию доверенного лица, сборы за оценку имущества, сборы за оформление ипотеки и регистрационные сборы. Эти расходы определены заранее и не включают плату за обслуживание, плату за обслуживание дома или плату за коммунальные услуги. Этот
                        Калькулятор обеспечивает базовые предположения на основе вашего ввода.
                    </p>
                </div>
                <div class="col-lg-6">
                    <h4>{{--Down Payment--}}Первоначальный взнос</h4>
                    <p>
...
{{--                        purchases.--}}
                        Экономия на первоначальном взносе в ОАЭ — одна из самых больших проблем при покупке. Вероятно, это одна из причин, по которой 70% экспатов арендуют жилье. Согласно руководящим принципам Центрального банка ОАЭ, максимальная сумма кредита к стоимости (LTV) для экспатриантов составляет 75%, при условии, что это первая ипотека, а стоимость недвижимости не превышает 5 миллионов дирхамов. Для покупок на сумму более 5 миллионов дирхамов LTV снижается до 65 процентов и 60 процентов для всех последующих покупок.
                    </p>
                </div>
            </div>
        </div>
        ...
        function chartjs(finalMonthlyRentingCost,finalMonthlyBuyingCost) {
            ...
            var myChart = new Chart(ctx, {
                ...
                data: {
                    ...
                    labels: ['АРЕНДА ЕЖЕМЕСЯЧНАЯ\n СТОИМОСТЬ', 'КУПИТЬ ЕЖЕМЕСЯЧНУЮ\n СТОИМОСТЬ'],
                    datasets: [{
                        label: '',
