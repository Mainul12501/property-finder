                                        ...
                                        <div class="dropdown-wrapper-content">
                                            <div class="range-selector">
                                                <div class="range-selector-box">
                                                    ...
                                                    <input type="text" class="form-control" name="min_price" placeholder="{{ Session::has('rus') ? 'Мин. Цена' : '' }}{{ Session::has('kaz') ? 'Мин. Бағасы' : '' }}{{ Session::has('eng') ? 'Min. Price' : '' }} (AED)">
                                                </div>
                                                ...
                                                <div class="range-selector-box">
                                                    ...
                                                    <input type="text" class="form-control" name="max_price" placeholder="{{ Session::has('rus') ? 'Максимум. Цена' : '' }}{{ Session::has('kaz') ? 'Максималды. Бағасы' : '' }}{{ Session::has('eng') ? 'Max. Price' : '' }} (AED)">
                                                </div>
                                            </div>
