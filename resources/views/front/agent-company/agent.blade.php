    ...
    <section class="py-5" style="background-color: #f3f3f3">
        <div class="container">
            <div class="row">
                <div class="col-md-8">
                    <div class="card card-body">
                        <div class="row border-bottom">
                            <div class="col-md-4">
                                <div>
                                    <img src="{{ asset($agent->image) }}" class="img-fluid" alt="client name" style="width: 260px;" >
                                </div>
                            </div>
                            <div class="col-md-8 ">
                                <div class="mt-5 ms-5" style="">
                                    <h4 class="font-weight-light">{{ $agent->name }}</h4>
                                    <span style="font-size: 16px">{{ $agent->position }}</span>
                                </div>
                                <div class="row ms-5 mt-4 ms-0">
                                    <div class="col-4 ps-0">{{ Session::has('kaz') ? 'ҰЛТЫ' : '' }}{{ Session::has('rus') ? 'НАЦИОНАЛЬНОСТЬ' : '' }}{{ Session::has('eng') ? 'NATIONALITY' : '' }}:</div>
                                    <div class="col-8">{{ $agent->nationality }}</div>
                                </div>
                                <div class="row ms-5 mt-2 ms-0">
                                    <div class="col-4 ps-0">{{ Session::has('kaz') ? 'ТІЛДЕР' : '' }}{{ Session::has('rus') ? 'ЯЗЫКИ' : '' }}{{ Session::has('eng') ? 'LANGUAGES' : '' }}:</div>
                                    <div class="col-8">{{ $agent->languages }}</div>
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-12">
                                <div class="mt-3 ps-5">
                                    <h5 class="font-weight-light">{{ Session::has('kaz') ? 'ЖЕКЕ АҚПАРАТ' : '' }}{{ Session::has('rus') ? 'ЛИЧНАЯ ИНФОРМАЦИЯ' : '' }}{{ Session::has('eng') ? 'PERSONAL INFORMATION' : '' }}</h5>
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="row mt-2">
                                                <div class="col-md-6">
                                                    <span class="text-secondary">{{ Session::has('kaz') ? 'БЕЛСЕНДІ ЖАРНАМАЛАР' : '' }}{{ Session::has('rus') ? 'АКТИВНЫЕ ОБЪЯВЛЕНИЯ' : '' }}{{ Session::has('eng') ? 'ACTIVE ADS' : '' }}:</span>
                                                </div>
                                                <div class="col-md-6">
                                                    <a href=""> {{ count($agent->properties) }} {{ Session::has('kaz') ? 'сипаттамалары' : '' }}{{ Session::has('rus') ? 'характеристики' : '' }}{{ Session::has('eng') ? 'Characteristics' : '' }}</a>
                                                </div>
                                            </div>
                                            <div class="row mt-2">
                                                <div class="col-md-6">
                                                    <span class="text-secondary">{{ Session::has('kaz') ? 'BRN' : '' }}{{ Session::has('rus') ? 'БРН' : '' }}{{ Session::has('eng') ? 'BRN' : '' }}:</span>
                                                </div>
                                                <div class="col-md-6">
                                            ...
                                            <div class="row mt-2">
                                                <div class="col-md-6">
                                                    <span class="text-secondary">{{ Session::has('kaz') ? 'ТӘЖІРИБЕ' : '' }}{{ Session::has('rus') ? 'ОПЫТ С' : '' }}{{ Session::has('eng') ? 'EXPERIENCE Till' : '' }}:</span>
                                                </div>
                                                <div class="col-md-6">
                                                    <span>{{ $agent->experience_since }}</span>
                                                </div>
                                            </div>
                                            <div class="row mt-2">
                                                <div class="col-md-6">
                                                    <span class="text-secondary">{{ Session::has('kaz') ? 'LINKEDIN' : '' }}{{ Session::has('rus') ? 'ЛИНКЕДИН' : '' }}{{ Session::has('eng') ? 'LINKEDIN' : '' }}:</span>
                                                </div>
                                                <div class="col-md-6">
                                                    <a href="{{ $agent->linkedin_profile_url }}" style="text-decoration: none;" target="_blank">{{ Session::has('kaz') ? 'профильді көру' : '' }}{{ Session::has('rus') ? 'просмотреть профиль' : '' }}{{ Session::has('eng') ? 'view profile' : '' }}</a>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="row mt-2">
                                                ...
                                                <div class="col-md-9">{{ $agent->location }}</div>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                ...
                <div class="col-md-4">
                    <div class="card card-body">
                        <h6 class="text-uppercase">{{ Session::has('kaz') ? 'Осы агентке хабарласыңыз' : '' }}{{ Session::has('rus') ? 'Связаться с этим агентом' : '' }}{{ Session::has('eng') ? 'Contact this agent' : '' }}</h6>
                        <div class="row d-grid px-4 mt-4">
                            <a href="tel:{{ $agent->phone }}" class="btn btn-orange-type col-12 text-white py-2">
                        ...
                        <div class="row d-grid px-4 mt-2 pb-5">
                            <a href="" class="btn btn-orange-type col-12 text-white py-2">
                    ...
                    <div class="mt-4 card card-body">
                        <h6>{{ Session::has('kaz') ? 'Компания' : '' }}{{ Session::has('rus') ? 'Компания' : '' }}{{ Session::has('eng') ? 'Company' : '' }}</h6>
                        <div class="row">
                            <div class="col-md-5">
                                <div>
                                    <img src="{{ asset($agent->company->big_logo_image) }}" alt="" style="height: 57px; width: 103px;">
                                </div>
                            </div>
                            <div class="col-md-7">
                                <span>{{ $agent->company->name }}</span> <br>
                                <a href="{{ route('company-details',['id' => $agent->company->id, 'name'=>$agent->company->name]) }}">{{ Session::has('kaz') ? 'профильді көру' : '' }}{{ Session::has('rus') ? 'просмотреть профиль' : '' }}{{ Session::has('eng') ? 'view profile' : '' }}</a>
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <div>
                            <nav>
                                <div class="nav nav-tabs" id="nav-tab" role="tablist">
                                    <button class="nav-link " id="nav-home-tab" data-bs-toggle="tab" data-bs-target="#nav-home" type="button" role="tab" aria-controls="nav-home" aria-selected="true">{{ Session::has('kaz') ? 'Мен туралы' : '' }}{{ Session::has('rus') ? 'Обо мне' : '' }}{{ Session::has('eng') ? 'About me' : '' }}</button>
                                    <button class="nav-link active" id="nav-profile-tab" data-bs-toggle="tab" data-bs-target="#nav-profile" type="button" role="tab" aria-controls="nav-profile" aria-selected="false">{{ Session::has('kaz') ? 'Менің қасиеттерім' : '' }}{{ Session::has('rus') ? 'Мои свойства' : '' }}{{ Session::has('eng') ? 'My properties' : '' }} ({{ count($agent->properties) }})</button>
                                </div>
                            </nav>
...
{{--                                                        </form>--}}
                                                ...
                                                <div class="col-md-2">{{ Session::has('kaz') ? 'Жалпы меншік' : '' }}{{ Session::has('rus') ? 'Общая недвижимость' : '' }}{{ Session::has('eng') ? 'General property' : '' }}: {{ count($agent->properties) }}</div>
                                            </div>
                                                                ...
                                                                <div class="rent-featured-start-slider">
                                                                    ...
                                                                    <div id="carouselTen" class="carousel slide mb-3" data-bs-ride="carousel" data-bs-interval="false">
                                                                        <div class="carousel-indicators">
                                                                            @foreach($property->subImages as $key => $subIndex)
                                                            ...
                                                            <div class="rent-featured-end">
                                                                <div class="rent-featured-mid">
                                                                    ...
                                                                    <div class="rent-featured-mid-amenities">
                                                                      ...
                                                                      <span>
                                                                        ...
                                                                        <div class="rent-featured-mid-amenities-single">
                                                                            <p>{{ $property->property_size }} sqft</p>
                                                                        </div>
                                                                    </div>
                                                                ...
                                                                <div class="rent-featured-company">
                                                                    ...
                                                                    <div class="rent-featured-company-logo">
                                                                        <img src="{{ asset($agent->company->big_logo_image) }}" alt="Logo" class="img-fluid">
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
