    ...
    <section class="py-5" style="background-color: #f3f3f3">
        <div class="container">
            <div class="row">
                <div class="col-md-8">
                    <div class="card card-body">
                        <div class="row border-bottom">
                            ...
                            <div class="col-md-8 ">
                                ...
                                <div class="row ms-5 mt-4 ms-0">
                                    <div class="col-4 ps-0">НАЦИОНАЛЬНОСТЬ:</div>
                                    <div class="col-8">{{ $agent->nationality }}</div>
                                </div>
                                <div class="row ms-5 mt-2 ms-0">
                                    <div class="col-4 ps-0">ЯЗЫКИ:</div>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="mt-3 ps-5">
                                    <h5 class="font-weight-light">ЛИЧНАЯ ИНФОРМАЦИЯ</h5>
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="row mt-2">
                                                <div class="col-md-6">
                                                    <span class="text-secondary">АКТИВНЫЕ ОБЪЯВЛЕНИЯ:</span>
                                                </div>
                                                <div class="col-md-6">
                                                    <a href=""> {{ count($agent->properties) }} характеристики</a>
                                                </div>
                                            </div>
                                            <div class="row mt-2">
                                                <div class="col-md-6">
                                                    <span class="text-secondary">БРН:</span>
                                                </div>
                                                <div class="col-md-6">
                                            ...
                                            <div class="row mt-2">
                                                <div class="col-md-6">
                                                    <span class="text-secondary">ОПЫТ С:</span>
                                                </div>
                                                <div class="col-md-6">
                                            ...
                                            <div class="row mt-2">
                                                <div class="col-md-6">
                                                    <span class="text-secondary">ЛИНКЕДИН:</span>
                                                </div>
                                                <div class="col-md-6">
                                                    <a href="{{ $agent->linkedin_profile_url }}" style="text-decoration: none;" target="_blank">view profile</a>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                ...
                <div class="col-md-4">
                    <div class="card card-body">
                        <h6 class="text-uppercase">Связаться с этим агентом</h6>
                    ...
                    <div class="mt-4 card card-body">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-7">
                                ...
                                <a href="{{ route('company-details',['id' => $agent->company->id, 'name'=>$agent->company->name]) }}">view profile</a>
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <div>
                            <nav>
                                <div class="nav nav-tabs" id="nav-tab" role="tablist">
                                    <button class="nav-link " id="nav-home-tab" data-bs-toggle="tab" data-bs-target="#nav-home" type="button" role="tab" aria-controls="nav-home" aria-selected="true">About Me</button>
                                    <button class="nav-link active" id="nav-profile-tab" data-bs-toggle="tab" data-bs-target="#nav-profile" type="button" role="tab" aria-controls="nav-profile" aria-selected="false">My Properties (70)</button>
                                </div>
                            </nav>
                                ...
                                <div class="tab-pane fade show active" id="nav-profile" role="tabpanel" aria-labelledby="nav-profile-tab">
                                    ...
                                    <div class="container py-5">
                                            ...
                                            <div class="row mb-3">
                                                ...
                                                <div class="col-md-2">Общая недвижимость: {{ count($agent->properties) }}</div>
                                            </div>
