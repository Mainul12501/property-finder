...
@section('content')
    ...
    <div class="card">
        ...
        <div class="card-body">
            <div>
                <form action="{{ isset($agent)? route('admin.agents.update', $agent->id) : route('admin.agents.store') }}" method="post" enctype="multipart/form-data">
                    @csrf
                    @if(!empty($agent))
                        @method('PATCH')
                    @endif
                                ...
                                <div  class="col-md-8">
                                    <select name="company_id" id="" class="form-control">
                                        ...
                                        @foreach($companies as $company)
                                            <option value="{{ $company->id }}" {{ isset($agent) && $company->id == $agent->company_id ? 'selected' : '' }}>{{ $company->name }}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
                        ...
                        <div class="col-md-6">
                            <div class="form-group row">
                                ...
                                <div  class="col-md-8">
                                    ...
                                    @if(isset($agent))
                                        <img src="{{ asset($agent->image) }}" alt="{{ $agent->name.'-logo' }}" class="table-img-size-round" />
                                    @endif
                                </div>
                            </div>
                        </div>
