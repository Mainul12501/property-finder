                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group row">
                                <label for="name" class="col-md-4">Site Title <sup class="text-danger">*</sup></label>
                                <div  class="col-md-8">
                        ...
                        <div class="col-md-6">
                            <div class="form-group row">
                                <label for="name" class="col-md-4">Site Name <sup class="text-danger">*</sup></label>
                                <div  class="col-md-8">
                        ...
                        <div class="col-md-6">
                            <div class="form-group row">
                                <label for="name" class="col-md-4">Site Logo <sup class="text-danger">*</sup></label>
                                <div  class="col-md-8">
                        ...
                        <div class="col-md-6">
                            <div class="form-group row">
                                <label for="name" class="col-md-4">Site Banner</label>
                                <div  class="col-md-8">
                        ...
                        <div class="col-md-12">
                            <div class="form-group row">
                                <label for="name" class="col-md-2">Site meta</label>
                                <div  class="col-md-10">
                        ...
                        <div class="col-md-12">
                            <input type="submit" class="btn btn-outline-secondary btn-block" value="{{ isset($siteSetting) ? 'Update' : 'Add' }} Site Info">
                        </div>
                    </div>
                </form>
            </div>
