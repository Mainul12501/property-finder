...
@section('title')
    {{ env('APP_NAME') }} - {{ $blog->blog_title }}
@endsection

@section('body')
    <!-- Blog List Starts Here -->
{{--    <section class="blog-list mb-0 d-none d-md-none d-lg-block">--}}
...
{{--    <section class="blog-list-small d-lg-none d-block">--}}
{{--        <div class="container custom-container">--}}
{{--            <div class="row">--}}
{{--                <div class="col-lg-12">--}}
{{--                    <!-- BTN -->--}}
...
{{--    </section>--}}
    ...
    <section class="breadcrumb-area breadcrumb-area-blog calc-breadcrumb-area" style="margin-bottom: 30px;">
        <div class="container custom-container">
            <div class="row">
                <div class="col-lg-12">
